export const LogIn = () => {
    return (
        ...
        <div className="h-screen">
            <div className="flex">
            <div className=" ">
                <h1 className="font-bold text-3xl text-amber-700 mt-50 ml-50">SocioHub</h1>
                <h3 className="ml-50">SocioHub helps you to find new friends </h3>
            </div>
            <div className="grid gap-2 ml-40 mt-15 bg-gray-100 p-15 rounded-2xl">
                ...
                <hr />
                <button className="bg-fuchsia-700 text-white hover:bg-fuchsia-600 h-10  rounded-3xl" >Create New Account</button>
